...
Eine Übersicht des Schemas der nun vollständigen initialen  MySQL-Tabellen ist in Tabelle XX aufgeührt.

\textbf{HIER!}

\begin{table}[]
\caption{Übersicht des Schemas der initialen MySQL-Tabellen}
\label{tab:schema1}
\resizebox{\textwidth}{!}{%
\begin{tabular}{ll|ll}
