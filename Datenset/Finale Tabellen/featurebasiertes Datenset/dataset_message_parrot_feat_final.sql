...
--
-- Table structure for table `parrot_feat_final`
--

DROP TABLE IF EXISTS `parrot_feat_final`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `parrot_feat_final` (
...
--
-- Dumping data for table `parrot_feat_final`
--

LOCK TABLES `parrot_feat_final` WRITE;
/*!40000 ALTER TABLE `parrot_feat_final` DISABLE KEYS */;
/*!40000 ALTER TABLE `parrot_feat_final` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2020-04-25 11:57:18
