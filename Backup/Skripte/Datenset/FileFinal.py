# Script to create final tables from each software on file level.
...
for software in softwares:
	...
	query1 = "SELECT * FROM dataset." + software + "_file_metrics"
	...
	for row in result_set:
		...
		query2 = "SELECT corrective, bug_introducing FROM dataset." + software + " WHERE release_number = \"" + release + "\" and filename = \"" + filename + "\""
		...
		for elem in result_set2:
			...
			query3 = "INSERT INTO " + software + "_file_final (name, release_number, filename, comm, adev, ddev, exp, oexp, modd, mods, nloc, cyco, addl, reml, label) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
