# Script to perform random forest classification on file-level.
...
for ratio in ratios:
	...
	model = RandomForestClassifier(n_estimators = 200, random_state = 0, max_features = "sqrt")	
	model.fit(X_train, Y_train)
	
	filename = "rf_model_file_smoted.pkl"
