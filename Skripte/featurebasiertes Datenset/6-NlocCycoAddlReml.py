...
for software in softwares:
	...
	query1 = "SELECT release_number, feature FROM " + software + "_feat_metrics"
	...
	for row in result_set:
		...
		query2 = "SELECT nloc, cycomplexity, lines_added, lines_removed FROM " + software + " WHERE release_number = \"" + release + "\" AND feature = \"" + feature + "\""		
