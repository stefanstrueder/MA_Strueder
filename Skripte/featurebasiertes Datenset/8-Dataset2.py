# Second script to create final tables from each software on feature level.
...
for software in softwares:
	...
	query1 = "SELECT release_number, feature FROM " + software + "_feat_final group by release_number, feature;"
	...
	for row in result_set:
		...
		query2 = "SELECT * FROM " + software + "_feat_final where release_number = \"" + release + "\" AND feature = \"" + feature + "\"" 
		...
		query3 = "INSERT INTO " + software + "_feat_final_new (name, release_number, feature, comm, adev, ddev, exp, oexp, modd, mods, nloc, cyco, addl, reml, label) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
		val = (software, release, feature, comm_mean, adev_mean, ddev_mean, exp_mean, oexp_mean, modd_mean, mods_mean, nloc_mean, cyco_mean, addl_mean, reml_mean, label)
