# Script to create final tables from each software on feature level.
...
for software in softwares:
	...
	query1 = "SELECT * FROM dataset." + software + "_feat_metrics WHERE release_number = \"2.79\" or release_number = \"2.80\""
	...
	for row in result_set:
		...
		query2 = "SELECT corrective, bug_introducing FROM dataset." + software + " WHERE release_number = \"" + release + "\" and feature = \"" + feature + "\""
