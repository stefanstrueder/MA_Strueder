# Script to create dataset table from each software on file level.
...
for software in softwares:
	...
	query1 = "SELECT comm, adev, ddev, exp, oexp, modd, mods, nloc, cyco, addl, reml, label FROM dataset." + software + "_file_final;"
	...
	for elem in result_set:
		...
		query3 = "INSERT INTO file_final (comm, adev, ddev, exp, oexp, modd, mods, nloc, cyco, addl, reml, label) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
