...
for software in softwares:
	...
	query1 = "SELECT * FROM dataset_without_h." + software + "_feat_metrics"
	...
	for row in result_set:
		...
		query2 = "SELECT corrective, bug_introducing FROM dataset_message." + software + " WHERE release_number = \"" + release + "\" and feature = \"" + feature + "\""
		...
		for elem in result_set2:
			...
			query3 = "INSERT INTO dataset_message." + software + "_feat_final (name, release_number, feature, comm, adev, ddev, exp, oexp, modd, mods, nloc, cyco, addl, reml, label) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
