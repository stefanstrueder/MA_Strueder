# Script to calculate EXP metric on feature level.
...
# Calculate exp metric for each feature in each release
for software in softwares:
	...
	query3 = "SELECT release_number, feature, commit_author, lines_added, lines_removed FROM dataset." + software + " WHERE feature = %s AND release_number = %s GROUP BY release_number, feature, commit_author"
