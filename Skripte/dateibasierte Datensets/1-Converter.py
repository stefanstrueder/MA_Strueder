...
for software in softwares:
	...
	for elem in result_set2:
		...
		query3 = "INSERT INTO " + software + "_new (name, release_number, commit_hash, commit_author, commit_msg, filename, nloc, cycomplexity, lines_added, lines_removed, corrective, bug_introducing, refactor, date) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
