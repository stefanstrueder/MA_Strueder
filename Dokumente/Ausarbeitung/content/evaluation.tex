...
\begin{figure}
  \centering
  \subfloat[][scikit]{\includegraphics[width=0.5\linewidth]{images/feat_final_scikit}}
  \subfloat[][WEKA]{\includegraphics[width=0.5\linewidth]{images/feat_final_weka}}
  \caption{Vergleich der Accuracies der featurebasierten Klassifikatoren von scikit-learn und WEKA\label{fig:final-feat}}
\end{figure}

\begin{figure}
  \centering
  \subfloat[][scikit]{\includegraphics[width=0.5\linewidth]{images/file_final_scikit}}
  \subfloat[][WEKA]{\includegraphics[width=0.5\linewidth]{images/file_final_weka}}
  \caption{Vergleich der Accuracies der dateibasierten Klassifikatoren von scikit-learn und WEKA\label{fig:final-file}}
\end{figure}

\begin{table}[t]
\centering
\caption{Ergebnisse der Evaluationsmetriken von scikit-learn (\textbf{ÜBERARBEITEN})}
...
\begin{table}[t]
\centering
\caption{Ergebnisse der Evaluationsmetriken von WEKA (\textbf{ÜBERARBEITEN})}
\label{tab:met-weka}
\resizebox{\linewidth}{!}{%
...
\begin{table}[t]
\centering
\caption{Ergebnisse der Evaluationsmetriken des nicht-featurebasierten Vergleichs (\textbf{ÜBERARBEITEN})}
\label{tab:class-val}
\resizebox{\linewidth}{!}{%
