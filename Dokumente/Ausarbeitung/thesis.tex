...
\begin{table}
\centering
\caption{Erweiterte Ergebnisse der Evaluationsmetriken von scikit-learn}
\label{tab:met-scikit-extended}
\resizebox{\linewidth}{!}{%
...
\begin{table}
\centering
\caption{Erweiterte Ergebnisse der Evaluationsmetriken von WEKA}
\label{tab:met-weka-extended}
\resizebox{\linewidth}{!}{%
