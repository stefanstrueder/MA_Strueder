...
\begin{table}[t]
\centering
\caption{Subject systems \tb{type of data source is not so important here, rather the earliest and latest release used; also the links to the repos would be better (having a reference for each probably takes least space, see \cite{blender:online} as an example)}\tb{changed style to booktabs; also use for other tables}}
\label{tab:tools}
\resizebox{\linewidth}{!}{%
\begin{tabular}{lll} 
\toprule
 \textsf{project}  & \textsf{purpose}  & \textsf{data source}    \\ 
\midrule
...
\begin{figure*}[ht]
  \centering
  \subfloat[][Blender\\split ratio: $73:27$]{\includegraphics[width=0.5\linewidth]{release_blender}}
  \subfloat[][Busybox\\split ratio: $71:29$]{\includegraphics[width=0.5\linewidth]{release_busybox}}
  \qquad
  \subfloat[][Emacs\\split ratio: $71:29$]{\includegraphics[width=0.5\linewidth]{release_emacs}}
  \subfloat[][GIMP\\split ratio: $71:29$]{\includegraphics[width=0.5\linewidth]{release_gimp}}
  \qquad
  \subfloat[][Gnumeric\\split ratio: $75:25$]{\includegraphics[width=0.5\linewidth]{release_gnumeric}}  
  \subfloat[][gnuplot\\split ratio: $80:20$]{\includegraphics[width=0.5\linewidth]{release_gnuplot}}
  \qquad
  \subfloat[][Irssi\\split ratio: $71:29$]{\includegraphics[width=0.5\linewidth]{release_irssi}}
  \subfloat[][libxml2\\split ratio: $80:20$]{\includegraphics[width=0.5\linewidth]{release_libxml2}}
  \qquad
  \subfloat[][lighttpd\\split ratio: $67:33$]{\includegraphics[width=0.5\linewidth]{release_lighttpd}}
  \subfloat[][MPSolve\\split ratio: $75:25$]{\includegraphics[width=0.5\linewidth]{release_mpsolve}}
  \qquad
  \subfloat[][Parrot\\split ratio: $71:29$]{\includegraphics[width=0.5\linewidth]{release_parrot}}
  \subfloat[][Vim\\split ratio: $71:29$]{\includegraphics[width=0.5\linewidth]{release_vim}}
