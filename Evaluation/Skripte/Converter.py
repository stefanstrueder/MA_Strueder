...
for software in softwares:
	...
	for commit in RepositoryMining("blender", only_commits = id_list).traverse_commits():
	...
	for elem in result_set2:
		...
		query3 = "INSERT INTO " + software + "_new (name, release_number, commit_hash, commit_author, commit_msg, filename, nloc, cycomplexity, lines_added, lines_removed, change_type, diff, corrective, bug_introducing, refactor, feature, date) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"

		val = (elem[0], elem[1], elem[2], elem[3], elem[4], elem[5], elem[6], elem[7], elem[8], elem[9], elem[10], elem[11], elem[12], elem[13], elem[13], elem[14], date)
